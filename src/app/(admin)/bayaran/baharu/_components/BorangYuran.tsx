        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
          ...
          <div style={{ background: 'var(--card)', border: '1px solid var(--border)', borderRadius: '20px', padding: '24px' }}>
            ...
            <div style={{ marginBottom: '14px' }}>
              <label style={gayaLabel}>Jenis Bayaran</label>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '12px' }}>
              <div>
                <label style={gayaLabel}>Bulan Bayaran</label>
              ...
              <div>
                <label style={gayaLabel}>{pakej ? 'Jumlah Seorang (RM)' : 'Jumlah (RM)'}</label>
                <input
